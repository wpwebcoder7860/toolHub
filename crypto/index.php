    ...
    <script>
        class JsonFormatter {
            ...
            constructor() {
                ...
                this.formatButton = document.getElementById("decryptedData");
            ...
            handleChunkUpload(event) {
                ...
                if (!selectedProject) {
                    Swal.fire({
                        icon: 'warning',
                        text: 'Select project name before decrypting.',
                ...
                if (!inputValue) {
                    Swal.fire({
                        icon: 'warning',
                        text: 'Please paste encrypted data before formatting.',
                        allowOutsideClick: false,
                        allowEscapeKey: false,
            ...
            /** FETCH final decrypted JSON */
            fetchDecryptedResult() {
                const selectedProject = document.getElementById("projectSelect").value;
                fetch("server.php?getFinal=1&project_name=" + encodeURIComponent(selectedProject), {
                        method: "GET",
                    })
                    .then(r => r.text())
                    .then(data => {
                        ...
                        if (jsonDecode.status) {
                            this.outputField.value = JSON.stringify(jsonDecode.data, null, 4);
                        } else {
                            Swal.fire({
                                icon: 'error',
                                title: 'Oops...',
            ...
            copyOutput() {
                ...
                if (!outputValue) {
                    Swal.fire({
                        icon: 'warning',
                        text: 'There is no decrypted data to copy.',
                        allowOutsideClick: false,
                        allowEscapeKey: false,
                    ...
                    navigator.clipboard.writeText(outputValue)
                        .then(() => {
                            Swal.fire({
                                icon: 'success',
                                title: 'Copied!',
                                text: 'Decrypted data copied to clipboard',
                                timer: 1200,
            ...
            downloadOutput() {
                ...
                if (!outputValue) {
                    Swal.fire({
                        icon: 'warning',
                        text: 'There is no decrypted data to download.',
                        allowOutsideClick: false,
                        allowEscapeKey: false,
